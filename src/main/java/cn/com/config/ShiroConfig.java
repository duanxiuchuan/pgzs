...
//        filterChainDefinitionMap.put("/**/*.ttf", "anon");
        ...
        filterChainDefinitionMap.put("/newnews_files/**","anon");
        filterChainDefinitionMap.put("/assets/**","anon");
        filterChainDefinitionMap.put("/upload/**","anon");
        filterChainDefinitionMap.put("/wechat/**","anon");
        filterChainDefinitionMap.put("/font-awesome/**","anon");
        filterChainDefinitionMap.put("/MP_verify_A5gzWDekKynE5Kah.txt","anon");
//        filterChainDefinitionMap.put("/403.html", "perms");
        ...
        filterChainDefinitionMap.put("/manage/submit", "anon");
    ...
    public static void main(String[] args) {//8dbcfb8d35ad46dc7ad96733ef24ef3f
        String password = new Md5Hash("123456", "zongdai").toHex();
