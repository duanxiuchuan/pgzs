...
var layTips = {
     ...
     * Ajax 请求
     * @param msg 提示消息
     * @param isClose 是否关闭并刷新父页面
     */
    error:function(msg,isClose){
        layer.msg(msg, {time: 2000, icon: 5},layTips.closeParent(isClose));
    },
    success:function(msg,isClose){
        layer.msg(msg, {time: 2000, icon: 6},layTips.closeParent(isClose));
    },
    waring:function(msg,isClose){
        layer.msg(msg, {time: 2000, icon: 7},layTips.closeParent(isClose));
    }
 ...
 */
var ajaxUtil = {
config :function(contentType,processData,async){
	return {"contentType":contentType,"processData":processData,"async":async};
},
/**
 * Ajax 请求
 ...
 */
definAjax :function (url,param,config,type,callback) {
    $.ajax({
        url: url,
        type: type,
        data: param,
     ...
     * Ajax get请求
     * @param url Ajax需要地址
     * @param param Ajax需要参数
     * @param callback ajax结束回掉函数
     */
    getAjax:function (url,param,callback) {
        ajaxUtil.definAjax(url,param,ajaxUtil.config(undefined,true,true),"GET",callback);
    },
    /**
     * Ajax post请求
     * @param url Ajax需要地址
    ...
    postAjax:function (url,param,callback) {
        ajaxUtil.definAjax(url,param,ajaxUtil.config(undefined,true,true),"POST",callback);
    },
    /**
     * Ajax get请求不进行同步
     * @param url Ajax需要地址
     ...
     * @param callback ajax结束回掉函数
     */
    getAjaxNo:function (url,param,callback) {
        ajaxUtil.definAjax(url,param,ajaxUtil.config(undefined,true,false),"GET",callback);
    },
    /**
     * Ajax post请求不进行同步
     * @param url Ajax需要地址
     ...
     * @param callback ajax结束回掉函数
     */
    postAjaxNo:function (url,param,callback) {
        ajaxUtil.definAjax(url,param,ajaxUtil.config(undefined,true,false),"POST",callback);
    },
    /**
     * Ajax 文件上传
     * @param url Ajax需要地址
     ...
     * @param callback ajax结束回掉函数
     */
    fileAjax:function (url,param,callback) {
        ajaxUtil.definAjax(url,param,ajaxUtil.config(false,false,true),"POST",callback);
    }
}
